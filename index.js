...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nᴍᴜɴᴀᴠɪʀ sɪʀ😎. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
await xeon.setStatus(`munavir Bot Mode On Since ${uptime}`).catch((_) => _);
...
*Thank you for registering in the ᴍᴜɴᴀᴠɪʀ sɪʀ😎 Database*
...
*「 ᴍᴜɴᴀᴠɪʀ 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered ᴍᴜɴᴀᴠɪʀ*`)
		}, 2000)
        break
...
❑${prefix}kickarea
`
sendButMessage(from, menu, ` ᴍᴜɴᴀᴠɪʀ 𝚂𝙸𝚁`, [
          {
            buttonId: `command`,
            buttonText: {
